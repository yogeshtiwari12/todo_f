...
const AllUsers = () => {
  ...
  const getRoleColor = (role) => {
    const colors = {
      admin: "bg-indigo-100 text-indigo-700 ring-indigo-700/10",
      user: "bg-blue-100 text-blue-700 ring-blue-700/10",
      manager: "bg-emerald-100 text-emerald-700 ring-emerald-700/10",
      default: "bg-gray-100 text-gray-700 ring-gray-700/10"
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex  md:flex-row md:items-center md:justify-center mt-6 mb-4 gap-4">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-br from-indigo-500 to-purple-500 text-transparent bg-clip-text">User Management</h1>            <p className="text-gray-500 mt-1 ">Monitor and manage user accounts effectively</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-all">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-900">{uniqueRoles.length}</p>
              </div>
            </div>
